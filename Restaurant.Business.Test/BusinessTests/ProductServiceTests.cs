...
namespace Restaurant.Business.Test.BusinessTests
{
    public class ProductServiceTests
    {
        ...
        public async Task ProductServiceGetAllReturnsAllProducts()
        {
            ...
            var mockProductCategoryRepository = new Mock<IProductCategoryRepository>();
            ...
            //act
            IEnumerable<ProductModel> actual = await productService.GetAllAsync();
        ...
        public async Task ProductServiceGetAllProductCategoriesAsyncReturnsAllCategories()
        {
            ...
            var mockPR = new Mock<IProductRepository>();
            var mockPCR = new Mock<IProductCategoryRepository>();
            ...
            var productService = new ProductService(mockPR.Object, mockPCR.Object, UnitTestHelper.CreateMapperProfile());
        ...
        public async Task ProductServiceAddAsyncAddsProduct()
        {
            ...
            //assert
            mockPR.Verify(x => x.AddAsync(It.Is<Product>(c => c.Id == product.Id && c.ProductCategoryId == product.ProductCategoryId && c.Price == product.Price && c.ProductName == product.ProductName)), Times.Once);
        }
        ...
        public async Task ProductServiceAddCategoryAsyncAddsCategory()
        {
            ...
            //assert
            mockPCR.Verify(x => x.AddAsync(It.Is<ProductCategory>(c => c.Id == category.Id && c.CategoryName == category.CategoryName)), Times.Once);
        }

        [Test]
        public async Task ProductServiceAddAsyncThrowsRestaurantExceptionWithEmptyProductName()
        {
            //arrange
            var mockPR = new Mock<IProductRepository>();
            var mockPCR = new Mock<IProductCategoryRepository>();
        ...
        [TestCase(-500000)]
        [TestCase(-0.0001)]
        public async Task ProductServiceAddAsyncThrowsRestaurantExceptionIfPriceIsNegative(decimal price)
        {
            var mockPR = new Mock<IProductRepository>();
            var mockPCR = new Mock<IProductCategoryRepository>();
        ...
        [Test]
        public async Task ProductServiceAddCategoryAsyncThrowsRestaurantExceptionWithEmptyCategoryName()
        {
            //arrange
            var mockPR = new Mock<IProductRepository>();
            var mockPCR = new Mock<IProductCategoryRepository>();
        ...
        public async Task ProductServiceDeleteAsyncDeletesProduct(int id)
        {
            ...
            //assert
            mockPR.Verify(x => x.DeleteByIdAsync(id), Times.Once);
        }
        ...
        public async Task ProductServiceRemoveCategoryAsyncDeletesCategory(int id)
        {
            ...
            //assert
            mockPCR.Verify(x => x.DeleteByIdAsync(id), Times.Once);
        }
        ...
        public async Task ProductServiceUpdateAsyncUpdatesProduct()
        {
            ...
            //assert
            mockPR.Verify(x => x.Update(It.Is<Product>(c => c.Id == product.Id && c.ProductCategoryId == product.ProductCategoryId && c.Price == product.Price && c.ProductName == product.ProductName)), Times.Once);
        }

        [Test]
        public async Task ProductServiceUpdateAsyncThrowsRestaurantExceptionsWithEmptyName()
        {
            //arrange
            var mockPR = new Mock<IProductRepository>();
            var mockPCR = new Mock<IProductCategoryRepository>();
        ...
        public async Task ProductServiceUpdateCategoryAsyncUpdatesCategory()
        {
            ...
            //assert
            mockPCR.Verify(x => x.Update(It.Is<ProductCategory>(c => c.Id == category.Id && category.CategoryName == c.CategoryName)), Times.Once);
        }

        [Test]
        public async Task ProductServiceUpdateCategoryThrowsRestaurantExceptionsWithEmptyName()
        {
            //arrange
            var mockPR = new Mock<IProductRepository>();
            var mockPCR = new Mock<IProductCategoryRepository>();
